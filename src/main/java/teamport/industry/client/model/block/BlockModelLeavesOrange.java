...
public class BlockModelLeavesOrange extends BlockModelLeaves<BlockLogicLeavesOrangeFlowering> {
    ...
    public boolean render(Tessellator tessellator, int x, int y, int z) {
        ...
        if (growthRate > 0) {
            renderBlocks.overrideBlockTexture = grownOverlay;
        } else {
            renderBlocks.overrideBlockTexture = floweringOverlay;
        }
    ...
    public void renderBlockOnInventory(Tessellator tessellator, int metadata, float brightness, float alpha, @Nullable Integer lightmapCoordinate) {
        ...
        IconCoordinate cherryCoord = grownOverlay;
        GL11.glColor4f(brightness, brightness, brightness, alpha);
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, -1.0F, 0.0F);
        renderBottomFace(tessellator, bounds, 0.0F, 0.0F, 0.0F, cherryCoord);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 1.0F, 0.0F);
        renderTopFace(tessellator, bounds, 0.0F, 0.0F, 0.0F, cherryCoord);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 0.0F, -1.0F);
        renderNorthFace(tessellator, bounds, 0.0F, 0.0F, 0.0F, cherryCoord);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 0.0F, 1.0F);
        renderSouthFace(tessellator, bounds, 0.0F, 0.0F, 0.0F, cherryCoord);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(-1.0F, 0.0F, 0.0F);
        renderWestFace(tessellator, bounds, 0.0F, 0.0F, 0.0F, cherryCoord);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(1.0F, 0.0F, 0.0F);
        renderEastFace(tessellator, bounds, 0.0F, 0.0F, 0.0F, cherryCoord);
        tessellator.draw();
        GL11.glTranslatef(0.5F, 0.5F, 0.5F);
    }
}
