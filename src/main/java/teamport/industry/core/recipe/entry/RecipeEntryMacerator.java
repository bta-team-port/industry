...
import teamport.industry.core.recipe.adapter.RecipeMaceratorJsonAdapter;
 ...
 * @date 2024-12-23
 */
public class RecipeEntryMacerator extends RecipeEntryBase<RecipeSymbol, ItemStack, Void> implements HasJsonAdapter {
    ...
    public RecipeJsonAdapter<?> getAdapter() {
        return new RecipeMaceratorJsonAdapter();
    }
}
