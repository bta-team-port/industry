 ...
 * @date 2024-12-23
 */
public class RecipeMaceratorJsonAdapter implements RecipeJsonAdapter<RecipeEntryMacerator> {
    @Override
    public RecipeEntryMacerator deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        return new RecipeEntryMacerator(input, output);
    }

    @Override
    public JsonElement serialize(RecipeEntryMacerator src, Type typeOfSrc, JsonSerializationContext context) {
