...
public class BlockLogicOreUranium extends BlockLogic {
    public static WorldFeatureOre.OreMap variantMap = new WorldFeatureOre.OreMap();

    public BlockLogicOreUranium(Block<?> block, Block<?> parentBlock, Material material) {
    ...
    public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int meta, TileEntity tileEntity) {
        switch (dropCause) {
            ...
            case PROPER_TOOL:
            case PISTON_CRUSH:
                return new ItemStack[]{new ItemStack(IndItems.ORE_RAW_URANIUM)};
            default:
                return null;
        }
    }
